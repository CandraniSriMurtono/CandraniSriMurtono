"""
Django settings for candrani project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-xldkl2sqau*bg$$&%d%d-!g-qtx*w#5oa7uu^kq-33m$b)r7h@')
...
WSGI_APPLICATION = 'candrani.wsgi.application'
